...
from engine import (
    DEFAULT_INDEX, MODEL_CAPTIONS, MODEL_NAMES, RecoError, RecoSession,
)
...
div[role="radiogroup"]{ display:flex; width:100%; gap:10px; flex-wrap:nowrap; align-items:stretch; }
div[role="radiogroup"] > label{ flex:1 1 0; min-width:0; height:88px; box-sizing:border-box;
  display:flex; flex-direction:column; align-items:center; justify-content:flex-start; gap:5px;
  background:var(--bg2); border:1.5px solid var(--line); border-radius:12px; padding:14px 10px 10px;
  margin:0 !important; cursor:pointer; transition:all .15s; }
div[role="radiogroup"] > label > div:first-child{ display:none !important; }
div[role="radiogroup"] > label div[data-testid="stMarkdownContainer"] p{
  margin:0; white-space:nowrap; font-size:1rem; font-weight:600; color:var(--ink); text-align:center; }
...
div[role="radiogroup"] > label div[data-testid="stCaptionContainer"] p{
  margin:0; font-size:.74rem !important; font-weight:500; line-height:1.25;
...
with st.container(border=True):
    ...
    model_key = st.radio("Model", MODEL_NAMES, captions=MODEL_CAPTIONS,
